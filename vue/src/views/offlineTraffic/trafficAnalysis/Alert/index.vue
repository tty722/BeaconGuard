    ...
    <div class="alert-container">
        ...
        <section id="select-part">
            <div class="button-box">
                <div :class="['Overview', { active: currentPage === 'overview'|| currentPage === 'alertOverview' }]"
...
let currentComponent = ref(offlineStore.alert);
let currentPage = ref(offlineStore.alertString);
...
function setCurrentPage(name: string): void {
    ...
    offlineStore.alertString = name;
    currentPage.value = name;

    // 检查是否存在对应的组件
    if (componentMap[name]) {
        currentComponent.value = componentMap[name];
        offlineStore.alert = componentMap[name];
    } else {
