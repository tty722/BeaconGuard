...
onMounted(() => {
  setTimeout(async () => {
    ...
    await chartStore.alertCircle3();
    let data = chartStore.circle3;
    initChart(data);
  }, 50);
});
</script>
