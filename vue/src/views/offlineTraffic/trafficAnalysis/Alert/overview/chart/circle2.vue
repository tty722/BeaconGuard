...
onMounted(() => {
  setTimeout(async() => {
    ...
    await chartStore.alertCircle2();
    let data = chartStore.circle2;
    initChart(data);
  }, 50);
});
</script>
