...
const initChart = (data: circle4Type) => {
  ...
  mychart.setOption({
    title: {
      text: "Top Attack DestinationPort",
      left: "center",
    },
    tooltip: {
      trigger: "item",
...
onMounted(() => {
  setTimeout(async () => {
    ...
    await chartStore.alertCircle4();
    let data = chartStore.circle4;
    initChart(data);
  }, 50);
});
</script>
