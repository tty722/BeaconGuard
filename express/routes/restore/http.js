...
router.get(
  "/api/offline/restore/http/protocol",
  ...
  (req, res) => {
    ...
    fs.readFile(filePath, "utf8", (err, data) => {
      ...
      try {
        ...
        const dnsData = parsedData.filter((item) => item.protocol === "HTTP"); // 过滤出 protocol 为 HTTP 的数据
...
router.get("/api/offline/restore/http", verifyTokenMiddleware, (req, res) => {
